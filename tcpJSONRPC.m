...
//    [AppDelegate instance].veraConnector.allowKodiConnections = NO;
...
//            [AppDelegate instance].serverTCPConnectionOpen = YES;
            [[NSNotificationCenter defaultCenter] postNotificationName:@"tcpJSONRPCConnectionOpened" object:notificationObject userInfo:nil];
			break;
						...
						if (nil != output) {
                            ...
                            if (parseError == nil){
                                ...
                                if (((NSNull *)[notification objectForKey:@"method"] != [NSNull null])){
                                    ...
                                    [[NSNotificationCenter defaultCenter] postNotificationName:method object:notificationObject userInfo:paramsDict];
                                }
                            }
						}
					}
...
//            [AppDelegate instance].serverTCPConnectionOpen = NO;
            inCheck = NO;
            [[NSNotificationCenter defaultCenter] postNotificationName:@"tcpJSONRPCConnectionError" object:notificationObject userInfo:nil];
			break;
